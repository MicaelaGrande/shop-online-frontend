...
function ProductCard({ product }) {
  return (
    <div className="bg-white/20 backdrop-blur-md p-3 md:p-6 rounded-xl shadow-lg text-[#3163b3] flex flex-col gap-2 md:gap-4 cursor-pointer hover:bg-[#3163b3] hover:text-white transition-all duration-300 ease-out group max-w-sm">
